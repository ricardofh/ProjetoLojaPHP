				...
				<tbody>
					...
					?>
						...
						<tr>
							...
							<td> <?php echo $vencimento = implode('/', array_reverse(explode('-', $res[$i]['vencimento']))); ?></td>
					...
					<div class="row">
						<div class ="col-md-6">
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="valor" name="valor" placeholder="R$ Valor" required="" value="<?php echo @$valor ?>">
							</div>
						</div>	
						...
						<div class ="col-md-6">
							<div class="mb-3">
								...
								<input type="date" class="form-control" id="vencimento" name="vencimento" placeholder="Vencimento" required="" value="<?php echo @$vencimento ?>">
							</div>	
						</div>
					</div>
		...
		<div class="modal-content">
			...
			<form method="POST" id="form-baixar">
				<div class="modal-body">
					...
					<p>Confirmar Pagamento da Conta?</p>
				...
				<div class="modal-footer">
					...
					<button name="btn-baixar" id="btn-baixar" type="submit" class="btn btn-success">Dar Baixa</button>
...
<!--AJAX PARA DAR BAIXA NAS CONTAS -->
<script type="text/javascript">
